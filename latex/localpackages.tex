...
\usepackage{graphicx}
\usepackage{float} % [H] here floats when placement must not interrupt following paragraphs
\usepackage{placeins} % \FloatBarrier at chapter/section boundaries
...
% \let\eachwordone=\sl        % gb4e / linguistics glossing (unused in this thesis)
% \singlegloss
% \exewidth{(5.65)}
